...
import com.example.ticketing.ticket.strategy.SerializableAttemptService;
...
public class StrategyConfig {
    ...
    public TicketingStrategy serializableTicketingStrategy(ConflictMetrics metrics,
                                                            RetryWithBackoff retryWithBackoff,
                                                            SerializableAttemptService attemptService) {
        log.info(">>> Active strategy: SERIALIZABLE (PostgreSQL SSI + Retry Backoff)");
        return new SerializableTicketingStrategy(metrics, retryWithBackoff, attemptService);
    }
}
