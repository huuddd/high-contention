...
// =============================================================================
// Benchmark B1 — Stock=1 (Extreme Contention) — RESERVATION STRATEGY
// =============================================================================
// Scenario: 200 VUs fight for 1 seat using 2-step reserve→confirm flow
// Purpose:  Test reservation strategy under extreme contention
//
// Usage:
//   k6 run load-test/stock1-reservation.js -e BASE_URL=http://localhost:8080
// =============================================================================
